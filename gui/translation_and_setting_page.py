...
#------------翻译功能
    ...
    translate_button = ttk.Button(frame,text='开始翻译',
                                  command=lambda:translate_button_action(
                                      txt_label=file_path_label,
                                      glossary_label=glossary_path_label,
                                      output_label=output_path_label,
                                      progress_bar = progress_bar
                                  ))
    translate_button.grid(row=3, column=0, sticky=EW ,columnspan=2,padx=5,pady=5)

    progress_label = ttk.Label(frame,text='翻译进度',anchor=CENTER)
    progress_label.grid(row=4, column=0,sticky=EW,padx=2,pady=2)

    progress_bar = ttk.Progressbar(frame)
    progress_bar.grid(row=4, column=1, sticky=EW,padx=5,pady=5)
...
#-----------设置功能
    ...
    original_text_path_button.grid(row=5, column=0,sticky=EW,padx=5,pady=5)
    original_text_path_label.grid(row=5, column=1,sticky=EW,padx=5,pady=5)
